        ...
        <div class="text-caption text-center pa-4">
          <v-dialog>
            ...
            <template v-slot:default="{ isActive }">
              <v-card class="pt-4 pl-4 pr-4">
                <v-card-title class="text-overline"><u>Privacy Policy for Website Analytics</u></v-card-title>
                <v-card-text class="text-body-2">
                  ...
                  <p class="mb-2">You have the option to refuse the collection of data by Google Analytics by disabling cookies in your browser settings. Please check your browser’s settings to manage your cookie preferences.</p>
